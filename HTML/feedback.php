    ...
    <div class="container">
        <div class="p-5 mb-4 bg-light feedbackBg shadow-lg">
            <div class="container-fluid py-5">
                <form name="feedback_form" action="../processDbRequest/model/feedback.php" method="POST" id="feedback_form">
                    <div class="row">
                        <div class="col col-12 col-lg-6">
                            <div class="mb-3">
                                <label for="name" class="form-label">Name<span style="color:red">*</span></label>
                                <input type="name" class="form-control" placeholder="What should we call you?" name="name" id="name" required>
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="feedback" placeholder="Do include as many details as possible" id="feedback" aria-label="Feedback here" style="height:300px;" required></textarea>

                ...
                <form>
                    <div class="row">
                        <div class="col col-12 col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="name" class="form-control" placeholder="What should we call you?" id="name">
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">Email<span style="color:red">*</span></label>
                                <input type="email" class="form-control" placeholder="How should we contact you?" id="email">
                            </div>
                            <div class="mb-3">
                                <label for="type" class="form-label">Type of Feedback<span style="color:red">*</span></label>
                                <select id="type" name="type" class="form-select" aria-describedby="feedbackHelp">
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="Do include as many details as possible" aria-label="Feedback here" style="height:300px;"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="d-flex justify-content-center">
                            <button type="button" class="btn text-white top-50 start-50 customBtn" id="submitBtn" onclick="submitFeedback()">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
